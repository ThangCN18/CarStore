				...
				<div class="col-md-3 logo_agile mb-4">
					<h1 class="text-center">
						<a href="${pageContext.request.contextPath}/home" class="font-weight-bold font-italic" style="font-size: 22px;">
							<img style="width: 70px; margin-top: 12px; margin-left: -15px"  src="${pageContext.request.contextPath}/images/logo2.png" class="img-fluid">&nbsp;   Car Store
						</a>
					</h1>
<!-- 					&emsp;&emsp;&emsp;&emsp;<i class="fas fa-phone" style="color:black;font-size:14px;"></i>&nbsp;<a style="font-size:14px;" href="tel:+84 357863600">+84 357863600 Order Now</a> -->
				</div>
				<!-- //logo -->
				<!-- header-bot -->
